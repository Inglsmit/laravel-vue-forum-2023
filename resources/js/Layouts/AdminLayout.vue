<template>
    <div>
        ...
        <div class="w-5/6 flex items-start mx-auto py-4">
            <div class="w-1/4 bg-white mr-4 border border-gray-300">
                <h3 class="text-xl mr-4 p-4">Menu</h3>
                <div>
                    <div>
                        <Link class="block p-4 w-full border-t border-b border-gray-300" :href="route('admin.main.index')">Statistics</Link>
                    </div>
                    <div>
                        <Link class="block p-4 w-full border-b border-gray-300" :href="route('admin.complaints.index')">Complaints</Link>
                    </div>
                    <div>
