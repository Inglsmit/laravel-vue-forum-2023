<template>
    <div>
        <div class="flex items-center mb-8">
            <h3 class="text-xl mr-4">Complaints</h3>
        </div>
        <div>
            <div class="border border-gray-200 rounded-lg">
                <table class="text-center text-medium w-full">
                    ...
                    <tr>
                        ...
                        <th class="p-4 text-gray-700">Link on message</th>
                    ...
                    <tbody>
                        <tr v-for="complaint in complaints" class="text-gray-500">
                            ...
                            <td class="p-4">
                                <Link :href="route('themes.show', complaint.theme_id) + `#${complaint.message_id}`"> Link</Link>
                            </td>
                            <td class="p-4 whitespace-nowrap">{{ complaint.is_solved ? 'Solved' : 'On review'}}</td>
                            <td class="p-4">
