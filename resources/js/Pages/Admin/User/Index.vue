<template>
    <div>
        <div class="flex items-center mb-8">
            <h3 class="text-xl mr-4">Users</h3>
            <Link :href="route('admin.roles.create')" class="block mr-4 w-1/6 px-2 py-1 bg-white border border-gray-300 rounded-lg text-center">
                + role
            </Link>
        </div>
        <div>
                ...
                <table class="text-center text-medium w-full">
                    ...
                    <tr v-for="user in users" class="text-gray-500">
                        ...
                        <td class="p-4 relative">
                            <a @click.prevent="roleChange(user)" href="#">{{ user.is_role_change ? 'Close' : 'Choose'}}</a>
